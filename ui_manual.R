...
tabPanel(
  ...
  h4(
    HTML('<div style="padding:0 .5cm;"><div style="border:darkgrey 0px solid; background:darkorange; padding: .5cm .5cm"><font color="white">',
         '<b>RNA-seq 2G</b> is a web portal with >20 statistical methods that perform two-group analysis of differential gene expression.',
         'It uses read count data from RNA-seq or similar data matrix as input and generates test statistics in consistent format as output.', 
         '</font></div> </div>', '&nbsp;'
    )
  ),

    ...
    column(
      ...
      conditionalPanel(condition = 'input["result.select.table"] != ""',
        wellPanel(fluidRow(
          ...
          div(style="display: inline-block;", selectInput("result.select.table", label = "Select method", choices=list(), width='108px')),
          div(style="display: inline-block;", h4(HTML("&nbsp"))),
          div(style="display: inline-block;", selectInput("result.filter.p", label = 'P value', choices = choices.pv, width='64px')),
          div(style="display: inline-block;", h4(HTML("&nbsp"))),
          div(style="display: inline-block;", selectInput("result.filter.fc", label = 'Fold change', choices = choices.fc, width='96px')),   
          div(style="display: inline-block;", h4(HTML("&nbsp&nbsp"))),

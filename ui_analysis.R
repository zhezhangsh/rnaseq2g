...
tabPanel(
  ...
  #***** STEP 1 ******#
  wellPanel(
    rnaseq2g.write.header("Step 1. Upload a read count matrix"), br(),
  ...
  conditionalPanel(
    condition = 'input["analysis.step2.paired"] == "Unpaired" || input["analysis.step2.paired"] == "Paired"',
    wellPanel(
      rnaseq2g.write.header("Step 2. Specify analysis parameters"), br(),
  ...
  conditionalPanel(
    ...
    wellPanel(
      rnaseq2g.write.header("Step 3. Choose one or multiple DE methods"), br(),
  ...
  conditionalPanel(
    ...
    wellPanel(
      style = "border-color: lightgrey; border-width: 5px; border-radius: 25px;",
      fluidRow(
